...
export default async function InvoicePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  // Hämta ärendet, klienten och alla tidsloggar
  ...
  const dueDate = new Date(Date.now() + 30 * 24 * 60 * 60 * 1000).toLocaleDateString('sv-SE') // 30 dagar

  return (
    <main className="min-h-screen bg-slate-200 py-10 print:bg-white print:py-0">
      <div className="max-w-4xl mx-auto">
        
        {/* Kontroller som döljs vid utskrift (print:hidden) */}
        ...
        {/* Själva A4-pappret */}
        <div className="bg-white p-12 md:p-20 shadow-xl print:shadow-none print:p-0 min-h-[1056px] text-slate-900">
